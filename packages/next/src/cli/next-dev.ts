...
let rageRestartAttrs: { 'rage-restart': boolean; 'missing-next-dir': boolean } =
  { 'rage-restart': false, 'missing-next-dir': false }
    ...
    return new Promise<void>((resolve) => {
      ...
      child = fork(startServerPath, {
        ...
        env: {
          ...
          NEXT_PRIVATE_DEV_SPAN_ATTRS: JSON.stringify(rageRestartAttrs),
